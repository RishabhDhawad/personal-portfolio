...
export const serviceData = [
  ...
  },
  {
    ...
    description:
      "Deploying and managing applications with environment isolation and scalability in mind.",
    link: "",
  },
  {
    icon: assets.ui_icon,
    ...
    description:
      "Automating repetitive tasks and extracting structured data from complex web sources.",
    link: "",
  },
  {
...
export const infoList = [
  {
    ...
    title: "Languages",
    description: "HTML, CSS, JavaScript React Js, Next Js, Python, Django, FastAPI",
  },
  {
